...
namespace PagoAgilFrba.Devoluciones
{
    public partial class DevolverFactura : Form
    {
        ...
        private void ActulizarResultados()
        {
            ...
            if (ConexionDB.Procedure("buscarFacturaADevolver", parametros.get(), out facturasEncontradas))
            {
        ...
        {           
            ...
            {               
                ...
                parametros.add("@id_registroPago",dataGridViewBuscarFactura.CurrentRow.Cells["idRegistroPago"].Value);
                ...
                if (ConexionDB.Procedure("devolverFactura", parametros.get()))
                {
                    MessageBox.Show("Se devolvio la factura nro: " + dataGridViewBuscarFactura.CurrentRow.Cells["idFactura"].Value.ToString());                        
                }
